  ...
  <div>
    ...
    <el-dialog title="添加用户" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="addUser" native-type="submit">确 定
        </el-button>
      ...
      return {
        ...
        addFormRules: {
          username: [
            ...
            { min: 3, max: 8, message: '用户名的长度在 3 到 8 个字符', trigger: 'blur' }
          ],
          password: [
            { required: true, message: '请输入密码', trigger: 'blur' },
            { min: 6, max: 16, message: '密码的长度在 6 到 16 个字符', trigger: 'blur' }
          ],
          email: [
